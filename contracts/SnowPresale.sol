// ref_010325: .../legacy/Snow_Bank_MasterChef-main/contracts/
...
contract SNOWPresale is IERC721Receiver, ReentrancyGuard {
    ...
    uint256[] public soldedNFTs; // house: not in use (typo: 'solded')
    ...
    uint256 public rate = 5; // house: not in use
